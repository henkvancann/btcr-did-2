...
To build your own Docker image use this section. If you want to use the resulting Docker image, head over to [Unpackaging it in one CLI command](https://github.com/hvancann/btcr-DID-2#Unpackaging%20it%20in%20one%20CLI%20command) below.
